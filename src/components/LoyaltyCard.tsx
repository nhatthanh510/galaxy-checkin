...
export function LoyaltyCard({ program }: { program: LoyaltyProgram }) {
  return (
    <div className="rounded-3xl bg-gradient-to-br from-purple-700/40 to-fuchsia-600/20 border border-purple-400/30 p-8">
      <div className="text-5xl font-black text-purple-200">{program.name}</div>
